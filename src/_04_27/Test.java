...
public class Test {
    ...
    static {
        ...
        teilnehmerSet.add(new Teilnehmer("Teilnehmer4", "OCPJP", ++ID, Note.ZWEI_MINUS));
        teilnehmerSet.add(new Teilnehmer("Teilnehmer5", "OCPJP", ++ID, Note.DREI));
        teilnehmerSet.add(new Teilnehmer("Teilnehmer6", "OCPJP", ++ID, Note.DREI_MINUS));
        teilnehmerSet.add(new Teilnehmer("Teilnehmer7", "OCPJP", ++ID, Note.VIER));
        teilnehmerSet.add(new Teilnehmer("Teilnehmer8", "OCPJP", ++ID, Note.VIER_MINUS));
