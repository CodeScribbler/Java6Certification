...
public class ExceptionDialog extends JDialog {
    ...
    public static void showDialog(Exception ex, String additional) {
        ExceptionDialog exDialog;
        if (additional == null)
            exDialog = new ExceptionDialog("Unerwarteter Systemfehler!", "Die Prozedur entweder neugestartet oder abgebrochen um die Datenintegrität zu gewährleisten!", ex);
        else
            exDialog = new ExceptionDialog("Unerwarteter Systemfehler!", additional, ex);
